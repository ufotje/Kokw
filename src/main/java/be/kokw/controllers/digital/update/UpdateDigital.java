 ...
 * This class is used to update a carrier
 */
...
public class UpdateDigital {
    ...
    @FXML
    public void search() {
        digital = repo.findOne(Integer.parseInt(id.getText()));
        if (digital != null) {
            ...
            Warning.alert("No Carrier Found!", "De drager met "  + id.getText() + " als id werd niet gevonden!");
            ChangeScene.init("/fxml/home.fxml", "KOKW - Het verleden draait altijd mee!");
        }
    }

    private void setBaseFields(VBox vBox){
    ...
    private void setDonatedFields(VBox vBox){
    ...
    private void setTradeFields(VBox vBox){
        if (digital.isTraded()) {
